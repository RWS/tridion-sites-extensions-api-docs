...
[Home](./index.md) &gt; [@tridion-sites/extensions](./extensions.md) &gt; [contentExplorerTableActionId](./extensions.contentexplorertableactionid.md)

## contentExplorerTableActionId variable

**Signature:**

```typescript
contentExplorerTableActionId: {
    export: "export";
    refresh: "refresh";
