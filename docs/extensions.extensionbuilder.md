...
| ----------------------------------------------------------------------------------- | --------- | ---------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| [accessControl](./extensions.extensionbuilder.accesscontrol.md)                     |           | [AccessControlExtensionsBuilder](./extensions.accesscontrolextensionsbuilder.md)                     | Provides a mechanism for customizing Access Control.                      |
...
| [publishingQueueExplorer](./extensions.extensionbuilder.publishingqueueexplorer.md) |           | [PublishingQueueExplorerExtensionsBuilder](./extensions.publishingqueueexplorerextensionsbuilder.md) | Provides a mechanism for customizing Publishing Queue Explorer.           |
