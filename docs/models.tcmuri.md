...
| [create](./models.tcmuri.create.md)                             | <code>static</code> | (publicationId: number, itemId: number, itemType: [TcmUriItemType](./models.tcmuriitemtype.md)<!-- -->, itemVersion?: number) =&gt; [TcmUri](./models.tcmuri.md) |                                                                        |
...
| [isEditableVersion](./models.tcmuri.iseditableversion.md)       |                     | boolean                                                                                                                                                          | If the item version is 0, then the item is editable. (e.g. tcm:1-1-v0) |
...
| [itemType](./models.tcmuri.itemtype.md)                         |                     | [TcmUriItemType](./models.tcmuriitemtype.md)                                                                                                                     |                                                                        |
