...
[Home](./index.md) &gt; [@tridion-sites/open-api-client](./open-api-client.md) &gt; [BatchOperationsService](./open-api-client.batchoperationsservice.md) &gt; [batchClassification](./open-api-client.batchoperationsservice.batchclassification.md)

## BatchOperationsService.batchClassification() method
...
```typescript
static batchClassification({ requestModel, }: {
        requestModel: BatchClassificationRequest;
...
| ----------------- | -------------------------------------------------------------------------------------------------------- | ----------- |
| { requestModel, } | { requestModel: [BatchClassificationRequest](./open-api-client.batchclassificationrequest.md)<!-- -->; } |             |
