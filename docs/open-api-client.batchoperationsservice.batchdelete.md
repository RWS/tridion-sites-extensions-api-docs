...
[Home](./index.md) &gt; [@tridion-sites/open-api-client](./open-api-client.md) &gt; [BatchOperationsService](./open-api-client.batchoperationsservice.md) &gt; [batchDelete](./open-api-client.batchoperationsservice.batchdelete.md)

## BatchOperationsService.batchDelete() method
...
```typescript
static batchDelete(requestModel: BatchOperationRequest): CancelablePromise<BatchOperationCreationResult>;
```
