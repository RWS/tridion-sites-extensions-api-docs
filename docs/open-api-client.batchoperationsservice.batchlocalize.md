...
[Home](./index.md) &gt; [@tridion-sites/open-api-client](./open-api-client.md) &gt; [BatchOperationsService](./open-api-client.batchoperationsservice.md) &gt; [batchLocalize](./open-api-client.batchoperationsservice.batchlocalize.md)

## BatchOperationsService.batchLocalize() method
...
```typescript
static batchLocalize(requestModel: BatchOperationRequest): CancelablePromise<BatchOperationCreationResult>;
```
